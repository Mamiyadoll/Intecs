...
<h3>Password</h3>
<input type="password" name="password1" id="password1" maxlength="50" placeholder="半角英数8文字以上">
<p id="pass_chk" style="display: none; color: red;">パスワードが半角英数8文字以上になっていません</p>
<h3>氏名</h3>
<input type="text" name="userName" id="userName" maxlength="100" placeholder="山田太郎">
<h3>郵便番号</h3>
<input type="text" name="postCode" id="postCode" maxlength="7" placeholder="ハイフンなし">
<p id="yuubin_chk" style="display: none; color: red;">郵便番号が数字7桁になっていません</p>
<h3>住所</h3>
<input type="text" name="address" id="address" maxlength="200">
<h3>電話番号</h3>
<input type="text" name="tel" id="tel" maxlength="20" placeholder="ハイフンなし">
<p id="phone_chk" style="display: none; color: red;">電話番号が形式に沿っていません</p>
<h3>メールアドレス</h3>
<input type="email" name="mail" id="mail" maxlength="254" placeholder="aaaa@gmail.com">
<p id="mail_chk" style="display: none; color: red;">メールアドレスが形式に沿っていません</p>
<input type="submit" value="会員登録" disabled onclick=" return check()" class="button">
</form>
</div>
<script>
        function check() {
            ...
            // パスワードチェック
            var regexp = /^([a-zA-Z0-9]{8,})$/;
            if (regexp.test(password1) != true) { document.getElementById('pass_chk').style.display = "block"; flag_chk = 1; }
